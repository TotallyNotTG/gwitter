...
document.write('                    <a class="link_A" href="explore"><button class="pages white">Explore</button></a>');
document.write('                    <a class="link_A" href="notify"><button class="pages white">Notify</button></a>');
document.write('                    <a class="link_A" href="messages"><button class="pages white">Messages</button></a>');
document.write('                    <a class="link_A" href="gwitterblue?currency"><button class="pages white">BLUE</button></a>');
document.write('                </div>');
